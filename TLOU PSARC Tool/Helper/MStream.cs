...
namespace Helper
{
    public class MStream : MemoryStream, IStream
    {
        ...
        Endian IStream.Endian { get => this.endian; set => endian = value; }
        public string Name { get; set; }

        public MStream(Endian endian = default) : base()
        {
            this.endian = endian;
        }
        ...
        public MStream(string FileName, byte[] FileData) : base(FileData, true)
        {
            Name = FileName;
        }
        ...
        public T[] GetArray<T>(int Count, bool SavePosition = true, int SeekToOffset = -1)
        {
            return ConvertTo<T>(GetBytes(Count * Marshal.SizeOf(typeof(T)), SavePosition, SeekToOffset));
        }

        public T Get<T>(bool SavePosition = true, int SeekToOffset = -1)
        {
            return ConvertTo<T>(GetBytes(Marshal.SizeOf(typeof(T)), SavePosition, SeekToOffset))[0];
        }
        ...
        #region int16,uint16
        public short GetShortValue(bool SavePosition = true, int SeekToOffset = -1)
        {
        ...
        public ushort GetUShortValue(bool SavePosition = true, int SeekToOffset = -1)
        {
            return (ushort)(GetShortValue(SavePosition, SeekToOffset));
        }


        public void SetShortValue(short value, bool SavePosition = true, int SeekToOffset = -1)
        {
        ...
        public void SetUShortValue(ushort value, bool SavePosition = true, int SeekToOffset = -1)
        {
            SetShortValue((short)value, SavePosition, SeekToOffset);
        }

        public void InsertShortValue(short value, bool SavePosition = true, int SeekToOffset = -1)
        {
        ...
        public void InsertUShortValue(ushort value, bool SavePosition = true, int SeekToOffset = -1)
        {
            InsertShortValue((short)value, SavePosition, SeekToOffset);
        }
        ...
        #region int32,uint32
        public int GetIntValue(bool SavePosition = true, int SeekToOffset = -1)
        {
        ...
        public uint GetUIntValue(bool SavePosition = true, int SeekToOffset = -1)
        {
            return (uint)(GetIntValue(SavePosition, SeekToOffset));
        }


        public void SetIntValue(int value, bool SavePosition = true, int SeekToOffset = -1)
        {
            byte[] array = BitConverter.GetBytes(value);
        ...
        public void SetUIntValue(uint value, bool SavePosition = true, int SeekToOffset = -1)
        {
            SetIntValue((int)value, SavePosition, SeekToOffset);
        }

        public void InsertIntValue(int value, bool SavePosition = true, int SeekToOffset = -1)
        {
        ...
        public void InsertUIntValue(uint value, bool SavePosition = true, int SeekToOffset = -1)
        {
            InsertIntValue((int)value, SavePosition, SeekToOffset);
        }
        ...
        #region int64,uint64
        public long GetInt64Value(bool SavePosition = true, int SeekToOffset = -1)
        {
        ...
        public ulong GetUInt64Value(bool SavePosition = true, int SeekToOffset = -1)
        {
            return (ulong)(GetInt64Value(SavePosition, SeekToOffset));
        }


        public void SetInt64Value(long value, bool SavePosition = true, int SeekToOffset = -1)
        {
            byte[] array = BitConverter.GetBytes(value);
        ...
        public void SetUInt64Value(ulong value, bool SavePosition = true, int SeekToOffset = -1)
        {
            SetInt64Value((long)value, SavePosition, SeekToOffset);
        }

        public void InsertInt64Value(long value, bool SavePosition = true, int SeekToOffset = -1)
        {
        ...
        public void InsertUInt64Value(ulong value, bool SavePosition = true, int SeekToOffset = -1)
        {
            InsertInt64Value((long)value, SavePosition, SeekToOffset);
        }
        ...
        #region Double
        public double GetDoubleValue(bool SavePosition = true, int SeekToOffset = -1)
        {
        ...
        public void SetDoubleValue(double value, bool SavePosition = true, int SeekToOffset = -1)
        {
            byte[] array = BitConverter.GetBytes(value);
        ...
        public void InsertDoubleValue(double value, bool SavePosition = true, int SeekToOffset = -1)
        {
        ...
        #region Float
        public float GetFloatValue(bool SavePosition = true, int SeekToOffset = -1)
        {
        ...
        public void SetFloatValue(float value, bool SavePosition = true, int SeekToOffset = -1)
        {
            byte[] array = BitConverter.GetBytes(value);
        ...
        public void InsertFloatValue(float value, bool SavePosition = true, int SeekToOffset = -1)
        {
        ...
        private byte[] GetString(Encoding encoding, char code = '\0')
        {
            ...
            if (encoding != Encoding.Unicode)
            {
                while (true)
                {
                    ...
                    if (StringValues[StringValues.Count - 1] == code)
                    {
                        break;
                    }
                }
            ...
            else
            {
                while (true)
                {
                    StringValues.Add(GetByteValue());
                    StringValues.Add(GetByteValue());
                    if (StringValues[StringValues.Count - 1] == code && StringValues[StringValues.Count - 2] == code)
                    {
                        break;
                    }
                }
        ...
        public string GetStringValueN(bool SavePosition = true, int SeekToOffset = -1, char code = '\0', Encoding encoding = null)
        {
            if (encoding == null)
            {
                encoding = Encoding.ASCII;
            ...
            Value = encoding.GetString(GetString(encoding, code)).TrimEnd(code);
            if (!SavePosition)
            {
        ...
        public void DeleteStringN(bool SavePosition = true, int SeekToOffset = -1, char code = '\0', Encoding encoding = null)
        {
            if (encoding == null)
            {
                encoding = Encoding.ASCII;
            ...
            DeleteBytes(GetString(encoding, code).Length, SavePosition, SeekToOffset);
            this.Seek(Position, SeekOrigin.Begin);
        }

        public void SetStringValueN(string String, bool SavePosition = true, int SeekToOffset = -1, char code = '\0', Encoding encoding = null)
        {
            if (encoding == null)
            {
                encoding = Encoding.ASCII;
            }
            SetBytes(encoding.GetBytes(String + code), SavePosition, SeekToOffset);
        }

        public void InsertStringValueN(string String, bool SavePosition = true, int SeekToOffset = -1, char code = '\0', Encoding encoding = null)
        {
            if (encoding == null)
            {
                encoding = Encoding.ASCII;
            }
            InsertBytes(encoding.GetBytes(String + code), SavePosition, SeekToOffset);
        }
        #endregion
